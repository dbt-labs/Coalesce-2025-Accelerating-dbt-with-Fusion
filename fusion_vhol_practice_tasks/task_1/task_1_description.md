...
**Problem: Build `fct_orders` by debugging a broken starter model** 

Visit this link for a gdocs version: 
...
* Your job is to use **dbt Fusion inside VS Code** to debug and complete the model.
